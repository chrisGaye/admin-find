<?php 
	...
	$query = $bdd->query("SELECT * FROM users WHERE email = '".htmlspecialchars($_SESSION['username'])."'");
			...
			<div class="row">
				  <div class="col-6">
				  		<div class="md-form">
				  				...
				  				<input type="text" name="prenom" id="name" class="form-control" required="" value="<?php echo $row[0][1]; ?>">
				   ...
				   <div class="col-6">
				  		<div class="md-form">
				  			  ...
				  			  <input type="text" name="nom" id="nom" class="form-control" required="" value="<?php echo $row[0][2]; ?>">
