	...
	<div class="container">
		...
		<div class="row d-flex justify-content-center">
			   <div class="col-auto" style="font-weight: bold;">
			   		 <i class="fas fa-database"></i>&nbsp;&nbsp;Création, Modification et Suppression des catégories de Forum
			   </div>
		</div>
		<br>
		<div class="row">
                ...
                <tr>
                   <td><?php echo $cpt;    
                    ...
                    <td> 
                     ...
                     <a href="updateCategorie.php?id=<?php echo $rep['id_cat']; ?>" style="color: white"><button type="submit" class="btn btn-primary">modifier</button></a>      
                    
                    </td>
                    <td>
                    <!-- <a href="/delete" class="delete" data-confirm="Are you sure to delete this item?">Delete</a> -->
                    <a href="deleteCategorie.php?id=<?php echo $rep['id_cat']; ?>" style="color: white" ><button type="submit" class="btn btn-danger">supprimer</button></a>
                     </td>
                </tr><?php   $cpt++; } ?>
                </tbody>
        </table>
