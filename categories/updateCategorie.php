<?php    
     ...
     $query=$bdd->query("SELECT * FROM categories WHERE id_cat='".$id."'");
		...
		<div class="row d-flex justify-content-center">
         ...
         <div class="row d-flex justify-content-center">
            <form action="saveUpdate.php?id=<?php echo $id;?>" method="POST">
               ...
               <input type="hidden" name="date" value="<?php echo $row[0][3]; ?>">
                <div class="md-form">
                ...
                <div class="md-form">
                    ...
                    <input type="text" class="form-control" name="desc" value="<?php echo $row[0][2]; ?>" id="desc">
                    <!-- <textarea name="" id="" cols="30" rows="10" name="contenu"></textarea> -->
                </div>
                <br><br>
